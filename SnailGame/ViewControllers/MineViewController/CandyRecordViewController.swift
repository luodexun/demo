//
//  CandyRecordViewController.swift
//  SnailGame
//
//  Created by Edison on 2019/12/5.
//  Copyright © 2019 DigitalSnail. All rights reserved.
//

import UIKit

class CandyRecordViewController: BaseViewController , collectionRefreshDelegate , collectionLoadMoreDelegate {
    ...
    func collectionLoadMoreAction(collectionView: UICollectionView) {
        count += 1
        candyRecordList(pageNum: String(count))
    }
    
    func candyRecordList(pageNum:String) {
        BusinessEngine.init().candyRecordList(page: pageNum, successResponse: { (baseModel) in
