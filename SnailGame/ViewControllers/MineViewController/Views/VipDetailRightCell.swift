...
protocol VipDetailRightDelegate {
    func vipDetailRightAction(detailModel:VipInfoDetailModel)
    func vipRightDetailAction()
}

class VipDetailRightCell: UICollectionViewCell , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout {
    
    var barView , bottomBarView : UIView?
    
    var rightCV : UICollectionView?
    
    var infoList = NSArray.init()
    
    var rightDelegate : VipDetailRightDelegate?
    ...
    @objc func rightDetailAction(sender:UIButton) {
        rightDelegate?.vipRightDetailAction()
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let detailModel:VipInfoDetailModel = infoList[indexPath.item] as! VipInfoDetailModel
        rightDelegate?.vipDetailRightAction(detailModel: detailModel)
    }
